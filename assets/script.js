...
>>>>>>> 6ba2775cfabd377d0ae85b0a7480d17208fd0016
...
async function getPosters(movieTitle) {
  return await fetch(`https://api.themoviedb.org/3/movie/${movieID}/images?api_key=${APIkey1}&language=en-US`)
  .then(function (response) {
    return response.json();
  })
  .then(function (data) { 
...
=======
  ...
  for (var r = 0; r < 6; r++) {
    ...
    cardRow.innerHTML += `<div class="movie_card column"><div class="callout" id="movie-title-decoration"><h3>${movieData[r].movieTitle}</h3><div><h4>You can find this movie on:</h4><p class="lead" id="providers-font">${movieData[r].providers}</h4></div><div class="reviews_decoration"></p><a href="${movieData[r].review[0]}" target="_blank"><p>REVIEW</p></a></div></div></div>`;
  }  
}
>>>>>>> 6ba2775cfabd377d0ae85b0a7480d17208fd0016
